...
public class PC {
    ...
    public static final int DEFAULT_RAM_SIZE = Option.ram.intValue(128) * 1024 * 1024;
    ...
    public PC(Clock clock, DriveSet drives, int ramSize, Calendar startTime) throws IOException {
        ...
        //BIOSes
        parts.add(new SystemBIOS(Option.bios.value("/resources/bios-v2/BIOS-bochs-latest.bin")));
        parts.add(new VGABIOS("/resources/bios-v2/VGABIOS-lgpl-latest.bin"));
